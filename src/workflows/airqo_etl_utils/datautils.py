...
class DataUtils:
    ...
    def extract_data_from_bigquery(
        ...
        Args:
            ...
            data_filter(dict, optional): A dictionary used to apply a `WHERE` clause when building the query. The format should be `{'field': value}`. The value can be a single literal or a list of values for filtering multiple entries.
